...
#define ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_8 ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_7 + 5
#define ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_9 ENCOUNTER_CHANCE_FISHING_MONS_SUPER_ROD_SLOT_8 + 5
...
const struct WildPokemon sRoute2_FireRed_LandMons[] =
{
    ...
    { 5, 5, SPECIES_RATTATA },
    { 5, 5, SPECIES_PIDGEY },
    { 4, 4, SPECIES_NIDORAN_F },
    { 4, 4, SPECIES_NIDORAN_M },
